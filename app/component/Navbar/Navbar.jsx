            ...
            <div className="max-w-7xl mx-auto px-6 py-2 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-10">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <Link href="/about" className={`${underlineClass} text-sm font-medium`}>About</Link>
                            ...
                            {openMenu === 'marketplace' && (
                                <div className="absolute left-0 top-full pt-2">
                                    <div className="bg-black/95 border border-gray-700 rounded-xl p-4 shadow-lg w-56">
                                        ...
                                        <Link href="/track" className="block py-2 text-sm hover:text-green-400">Track Orders</Link>
                        ...
                        >
                            ...
                            {openMenu === 'insights' && (
                                <div className="absolute left-0 top-full pt-2">
                                    <div className="bg-black/95 border border-gray-700 rounded-xl p-4 shadow-lg w-56">
                                        <Link href="/weather" className="block py-2 text-sm hover:text-green-400">Weather Updates</Link>
                                        <Link href="/marketrends" className="block py-2 text-sm hover:text-green-400">Market Prices & Trends</Link>
                                        <Link href="/tips" className="block py-2 text-sm hover:text-green-400">Farming Tips | Blog</Link>
